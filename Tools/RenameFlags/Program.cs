...
namespace RenameFlags
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            foreach (var filePath in files)
            {
                ...
                var fnCountry = fileName.ToLower().Replace("-", " ");

                var country = coSvc.GetByCountryName(fnCountry);
                if (country != null)
                {
                    found++;
                    var destFile = Path.Combine(dest, $"{country.countryCode}.svg");
    ...
    public class CountryService
    {
        ...
        {
            var country = CountriesList.FirstOrDefault(c => c.countryName.ToLower().Equals(countryName));
