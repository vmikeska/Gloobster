var Maps;
(function (Maps) {
    var NMapsOperations = (function () {
        function NMapsOperations() {
            this.countryShapes = new Common.CountryShapes();
            this.usShapes = new Common.UsStates();
        }
        NMapsOperations.prototype.setBaseMapsOperations = function (baseMapsOperations) {
            this.mapsDriver = baseMapsOperations;
        };
        NMapsOperations.prototype.drawCountry = function (country) {
            var _this = this;
        ...
        NMapsOperations.prototype.drawUsState = function (state) {
            var _this = this;
        ...
        NMapsOperations.prototype.drawUsStates = function (states) {
            var _this = this;
            states.forEach(function (state) {
                _this.drawUsState(state);
            });
        };
        NMapsOperations.prototype.drawCountries = function (countries) {
            var _this = this;
            countries.forEach(function (country) {
                _this.drawCountry(country);
            });
        };
        NMapsOperations.prototype.drawCity = function (city) {
            var marker = this.mapsDriver.drawPin(city);
            this.mapsDriver.drawPopUp(marker, city);
        };
        NMapsOperations.prototype.removeCity = function (gid) {
            this.mapsDriver.removePin(gid);
        };
        NMapsOperations.prototype.drawCities = function (cities) {
            var _this = this;
        ...
        NMapsOperations.prototype.drawPlace = function (place) {
            this.mapsDriver.drawPoint(place);
        };
        NMapsOperations.prototype.drawPlaces = function (places) {
            var _this = this;
            places.forEach(function (place) {
                _this.drawPlace(place);
            });
        };
        NMapsOperations.prototype.setView = function (lat, lng, zoom) {
            this.mapsDriver.setView(lat, lng, zoom);
        };
        return NMapsOperations;
    }());
    Maps.NMapsOperations = NMapsOperations;
