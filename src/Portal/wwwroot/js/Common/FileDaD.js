...
(function (Common) {
    ...
    var FileDaDOld = (function () {
        ...
        FileDaDOld.prototype.filesChose = function (files) {
            if (this.onFiles) {
                this.onFiles(files);
            }
        };
        FileDaDOld.prototype.isAdvancedUpload = function () {
            var div = document.createElement("div");
            return (("draggable" in div) || ("ondragstart" in div && "ondrop" in div)) && "FormData" in window && "FileReader" in window;
        };
        return FileDaDOld;
    })();
    Common.FileDaDOld = FileDaDOld;
})(Common || (Common = {}));
