...
namespace Gloobster.Portal.Controllers.Portal
{
    public class WikiController : PortalBaseController
    {
        ...
        public IActionResult Country()
        {
            ...
            vm.DosDonts = new List<DoDontTextSE>
            {
                new DoDontTextSE
                {
            ...
            vm.BaseTexts = new SectionTextsCommonSE
            {
                Text = "Text",
